...
<h2><?php  echo __('Shipper'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($shipper['Shipper']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('User'); ?></dt>
		<dd>
			<?php echo $this->Html->link($shipper['User']['name'], array('controller' => 'users', 'action' => 'view', $shipper['User']['id'])); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($shipper['Shipper']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Shipper'), array('action' => 'edit', $shipper['Shipper']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Shipper'), array('action' => 'delete', $shipper['Shipper']['id']), null, __('Are you sure you want to delete # %s?', $shipper['Shipper']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Shippers'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Shipper'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($shipper['Booking'] as $booking): ?>
		<tr>
